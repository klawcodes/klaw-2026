...
const CardNav: React.FC<CardNavProps> = ({
  ...
  return (
    ...
    >
      <nav
        ref={navRef}
        className={`card-nav ${isExpanded ? "open" : ""} block h-[60px] p-0 rounded-xl shadow-md relative overflow-hidden will-change-[height] bg-white/10 backdrop-blur-md border border-white/20`}
      >
        <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-[2]">
          ...
          <h2 className="text text-gray-400 card-nav-cta-button hidden md:inline-flex px-4 items-center h-full font-medium cursor-pointer transition-colors duration-300">
            Sumpah Mati
          </h2>
        </div>
